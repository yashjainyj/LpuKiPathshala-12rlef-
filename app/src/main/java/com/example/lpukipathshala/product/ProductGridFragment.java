...
//            getFilterData(selected_branch, view);
            ...
            collectionReference
                ...
                public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                    ...
                    ProductCardRecyclerViewAdapter adapter = new ProductCardRecyclerViewAdapter(getContext(),arrayList);
        ...
        {
            collectionReference.orderBy("price", direction).addSnapshotListener(new EventListener<QuerySnapshot>() {
                @Override
...
//
        ...
        public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
            ...
            final android.widget.SearchView searchView = (android.widget.SearchView) search.getActionView();
