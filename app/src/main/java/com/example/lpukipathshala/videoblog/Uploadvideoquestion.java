...
public class Uploadvideoquestion extends AppCompatActivity {
        ...
        muploadque.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!mqtype.getText().toString().equals("") && !mqquestion.getText().toString().equals("")) {
                    ...
                    progressDialog.show();
                    crefernce = firebaseFirestore.collection("VideoQuestions");
                    ...
                    crefernce.add(questionGetSet).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            ...
                            StorageReference store = storageReference.child("images/videoquestions/" + documentReference.getId() + ".jpg");
                            if (uri != null) {
                                store.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        firebaseFirestore.collection("VideoQuestions").document(documentReference.getId()).set(questionGetSet).addOnSuccessListener(new OnSuccessListener<Void>() {
                                            @Override
                                            public void onSuccess(Void aVoid) {
                                                progressDialog.dismiss();
                                                Toast.makeText(com.example.lpukipathshala.videoblog.Uploadvideoquestion.this,"uploaded", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    }
                                });
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(com.example.lpukipathshala.videoblog.Uploadvideoquestion.this, "CanNot Uploaded", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                else
                {
                    Toast.makeText(com.example.lpukipathshala.videoblog.Uploadvideoquestion.this, "Please fill the question type and question", Toast.LENGTH_SHORT).show();
                }
    ...
    private void showImageChooser(){
        ...
        CropImage.activity().start(com.example.lpukipathshala.videoblog.Uploadvideoquestion.this);
