...
public class Add_Equipment extends AppCompatActivity {
    private TextInputEditText Ename,bauthor,bEdition,branch,desc,price;
    TextInputLayout bauthor1,branch1,pname1;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        pname1.setHint("Equipment Name");
        //Ename.setHint("Equipment Name");
        bauthor = findViewById(R.id.bauthor);
        bEdition = findViewById(R.id.select_edition);
        drop1 = findViewById(R.id.drop1);
        bauthor.setVisibility(View.GONE);
        bEdition.setVisibility(View.GONE);
        drop1.setVisibility(View.GONE);
        branch = findViewById(R.id.branch);
        branch1 = findViewById(R.id.select_sem1);
        bauthor1 = findViewById(R.id.bauthor1);
        bauthor1.setVisibility(View.GONE);
        branch1.setVisibility(View.GONE);
        desc = findViewById(R.id.desc);
        price = findViewById(R.id.price);
        mAuth = FirebaseAuth.getInstance();
        circleImageView = findViewById(R.id.circleImageView);
        add= findViewById(R.id.btn_add_book);
        add.setText("Add Equipment");
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(!TextUtils.isEmpty(Ename.getText())  && !TextUtils.isEmpty(desc.getText())  && !TextUtils.isEmpty(branch.getText())&& !TextUtils.isEmpty(price.getText()))
                {
                    progressDialog.setMessage("please wait a while.....");
                    progressDialog.show();
                    if(uriProfileImage!=null) {
                        StorageReference d = storageReference.child("images/equipments/"+mAuth.getUid()+Ename.getText().toString()+".jpg");
...
//                                profileUrl = taskSnapshot.getStorage().getDownloadUrl().getResult().toString();
                                //Toast.makeText(Add_Equipment.this, "Upload Success" + profileUrl.toString(), Toast.LENGTH_SHORT).show();
                                collectionReference = firebaseFirestore.collection("Equipments");
                                String b_id = mAuth.getUid()+Ename.getText().toString();
                                Add_Equipment_Model add_book_model = new Add_Equipment_Model(mAuth.getUid(), MyUtility.TYPE, b_id,Ename.getText().toString(),branch.getText().toString(),desc.getText().toString(),price.getText().toString(),profileUrl.toString());
                                collectionReference.add(add_book_model).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                    @Override
                                    public void onSuccess(DocumentReference documentReference) {
                                        progressDialog.dismiss();
                                        Toast.makeText(Add_Equipment.this, "Equipment Uploaded Successfully", Toast.LENGTH_SHORT).show();
                                        finish();
                                    }
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        progressDialog.dismiss();
                                        Toast.makeText(Add_Equipment.this, "Error", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            ...
                            public void onFailure(@NonNull Exception e) {
                                progressDialog.dismiss();
                                Toast.makeText(Add_Equipment.this, "Failed", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                    else{
                ...
                {
                    Toast.makeText(Add_Equipment.this, "Field is empty", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                AlertDialog.Builder builder = new AlertDialog.Builder(Add_Equipment.this).setTitle("Choose Edition");
...
//
        ...
        branch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Add_Equipment.this).setTitle("Choose Branch");
                ...
                edittext[0].setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        PopupMenu popup = new PopupMenu(Add_Equipment.this,edittext[0]);
                        popup.getMenuInflater()
                                .inflate(R.menu.enginner, popup.getMenu());
                        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                            public boolean onMenuItemClick(MenuItem item) {
//                                Toast.makeText(Add_Equipment.this,"You Clicked : " + item.getTitle(),Toast.LENGTH_SHORT).show();
                ...
                edittext[1].setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        PopupMenu popup = new PopupMenu(Add_Equipment.this,edittext[1]);
                        popup.getMenuInflater()
...
//                                Toast.makeText(Add_Equipment.this,"You Clicked : " + item.getTitle(),Toast.LENGTH_SHORT).show();
                ...
                edittext[2].setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        PopupMenu popup = new PopupMenu(Add_Equipment.this,edittext[2]);
                        popup.getMenuInflater()
...
//                                Toast.makeText(Add_Equipment.this,"You Clicked : " + item.getTitle(),Toast.LENGTH_SHORT).show();
                ...
                edittext[3].setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        PopupMenu popup = new PopupMenu(Add_Equipment.this,edittext[3]);
                        popup.getMenuInflater()
...
//                                Toast.makeText(Add_Equipment.this,"You Clicked : " + item.getTitle(),Toast.LENGTH_SHORT).show();
                ...
                edittext[4].setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        PopupMenu popup = new PopupMenu(Add_Equipment.this,edittext[4]);
                        popup.getMenuInflater()
...
//                                Toast.makeText(Add_Equipment.this,"You Clicked : " + item.getTitle(),Toast.LENGTH_SHORT).show();
                ...
                edittext[6].setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        PopupMenu popup = new PopupMenu(Add_Equipment.this,edittext[6]);
                        popup.getMenuInflater()
...
//                                Toast.makeText(Add_Equipment.this,"You Clicked : " + item.getTitle(),Toast.LENGTH_SHORT).show();
                ...
                edittext[5].setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        PopupMenu popup = new PopupMenu(Add_Equipment.this,edittext[5]);
                        popup.getMenuInflater()
...
//                                Toast.makeText(Add_Equipment.this,"You Clicked : " + item.getTitle(),Toast.LENGTH_SHORT).show();
                ...
                edittext[7].setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        PopupMenu popup = new PopupMenu(Add_Equipment.this,edittext[7]);
                        popup.getMenuInflater()
...
//                                Toast.makeText(Add_Equipment.this,"You Clicked : " + item.getTitle(),Toast.LENGTH_SHORT).show();
    ...
    private void showImageChooser() {
        CropImage.activity().start(Add_Equipment.this);
    }
